...
const forget_check_new_password_hint = '请再次输入新密码';
const forget_check_text = '确定';
const forget_password_error_text = '请输入要修改的密码,密码不能为空';
const forget_password_same_error_text = '两次密码输入不一致，请检查后重新输入';
...
const home_action_parking = '智慧停车';
const home_action_report_repair = '物业报修';
const home_action_monitor = '摄像监控';
const home_action_pay = '缴纳费用';
const home_action_reserve_site = '场地预约';
...
const bluetooth_item_collapse = '收起';
const bluetooth_item_expand = '展开';
const bluetooth_item_open = '开门';
...
const parking_my_car = '我的车辆';
const parking_status = '目前状态:  ';
const parking_status_paring = '停车中';
const parking_status_no_paring = '未停车';
const parking_fee = '停车费用:  ';
const parking_unit_yuan = '元';
const parking_stop = '结束停车';
const parking_has_no_vip_card = '您尚未购买月卡';
const parking_has_no_vip_card_desc = '购买月卡后，可在生效期间内不限时免费停放车辆';
const parking_has_no_vip_card_hint = '(购买月卡时已产生的停车费用除外)';
const parking_has_no_vip_card_buy = '点击购买';
...
const parking_start_time = '开始  ';
const parking_end_time = '结束  ';
const parking_all_time = '共计  ';
...
const repair_action_reserve_succeed_title = '预约成功';
const repair_action_reserve_succeed_1 = '您可在';
const repair_action_reserve_succeed_2 = '个人页面';
